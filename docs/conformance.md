...
This checklist maps the normative July 2026 MCF 1.0 specification to implementation and verification. Reader UI behavior is intentionally listed separately from source-format conformance.

| Requirement                                                                   | Implementation                                         | Validation and tests                                                | Example                              |
| ----------------------------------------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------- | ------------------------------------ |
| Course package, one `manifest.yaml`, `chapters/`, chapter and lesson packages | `src/parser.ts` package discovery                      | `test/validation.test.ts`, `test/parser.test.ts`                    | both valid examples                  |
...
| Lesson frontmatter and activity-only body                                     | `parseLessonSource`                                    | frontmatter, boundary, malformed-container tests                    | both examples                        |
...
| Exact version and declared ordering                                           | parser                                                 | unsupported-version and order tests                                 | both examples                        |
